...
basic_banners = {
    "main": {
        ...
        "sub_data": {
            "header": f"'Добро пожаловать в нашего бота по пилатесу!' 🧘‍♂️ \n",
    ...
    "admin_panel": {
        ...
        "sub_data": {
            ...
            "text": "Здесь можно добавить новый или изменить информацию о уже существующем марафоне"
        }},
    "marathons": {
        "image": "AgACAgQAAxkBAAM3ZkkRLVru9AitbqEqmGJL5mI16_IAAuq_MRvHJlFSBNEZnEblpI8BAAMCAAN4AAM1BA",
        "sub_data": {
            "header": f"'О марафонах'\n",
